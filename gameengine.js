...
var characterSprites = [{leftFace: "./img/megaman/megaman_run_left.png", rightFace: "./img/megaman/megaman_run.png", xOffset: 0,
                        yOffset: 9},
    ...
    this.ctx.canvas.addEventListener("click", function (e) {
        ...
        if (that.insideMenu) {
            ...
            if (classPicked) {
                ...
                AM.getAsset(characterSprites[playerPick]["rightFace"]), AM.getAsset("./img/megaman/megaman_idle.png"), AM.getAsset("./img/megaman/megaman_shoot_run.png"),
        ...
        else if (!that.insideMenu) {
            GAME_ENGINE.addEntity(new Projectile(GAME_ENGINE, AM.getAsset("./img/megaman/pellet.png"), myPlayer.x + 20, myPlayer.y + 30, x, y));
            that.click = true;
        }   
